...
public class InputAxes : MonoBehaviour {
    ...
    public const string MENU_NAV_CONFIRM    = "Menu_Nav_Confirm";
    public const string MENU_NAV_CANCEL     = "Menu_Nav_Cancel";
    public const string MENU_NAV_HORIZONTAL = "Menu_Nav_Horizontal";
    public const string MENU_NAV_VERTICAL   = "Menu_Nav_Vertical";
}
